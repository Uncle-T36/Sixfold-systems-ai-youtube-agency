              ...
              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20 shadow-xl hover:shadow-2xl transition-all duration-300">
                ...
                <div className="flex space-x-2">
                  <motion.button
                    ...
                    className="flex-1 py-2 px-4 bg-gradient-to-r from-emerald-500 to-pink-500 text-white rounded-lg font-medium text-sm hover:from-emerald-600 hover:to-pink-600 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
